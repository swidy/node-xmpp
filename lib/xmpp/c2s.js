...
C2SStream.prototype.authenticate = function(username, password) {
    var self = this;
    var jid = new JID(username, this._domain ? this._domain.toString() : "");
...
C2SStream.prototype.onRegistration = function(stanza) {
    ...
    if (stanza.attrs.type === 'get') {
        ...
        var jid = new JID(register.getChildText('username'), this.server.options._domain)
